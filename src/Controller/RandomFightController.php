...
class RandomFightController extends AbstractController
{
    ...
    {
        $allFights = $fightRepository->findBy(['is_balanced' => true]);
    ...
    public function addVote(VoteRepository $votesRepository, int $vote_id, EntityManagerInterface $entityManager): Response
    {
